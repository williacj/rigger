...
| `ARCHITECTURE.md`, “Budgets” | “Instruction files carry one budget of their own, covering the root `AGENTS.md` and every nested one together” and “The budget is 2,500 words.” | The budget figure the two scripts read; it does not govern how a prose report supports its own numbers. |
